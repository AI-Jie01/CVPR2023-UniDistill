...
from perceptron.exps.multisensor_fusion.nuscenes._base_.base_nuscenes_cfg import CENTERPOINT_DET_HEAD_CFG
from perceptron.exps.multisensor_fusion.nuscenes.BEVFusion.BEVFusion_nuscenes_base_exp import BEVFusion, Exp as BaseExp
...
class BEVFusionCenterHead(BEVFusion):
    ...
    def forward(self, lidar_points, cameras_imgs, metas, gt_boxes, return_feature=False,**kwargs):
        ...
        if self.training:
            ...
            return ret_dict, tb_dict, model_output,x[0], forward_ret_dict['multi_head_features'], {}
        else:
            return forward_ret_dict
