...
class BBoxBEVL1Cost(object):
    ...
    def __call__(self, bboxes, gt_bboxes, **kwargs):
        ...
        pc_range = bboxes.new(kwargs["point_cloud_range"][3:5]) - bboxes.new(kwargs["point_cloud_range"][0:2])
    ...
    def assign(self, bboxes, gt_bboxes, gt_labels, cls_pred):
        ...
        if num_gts == 0 or num_bboxes == 0:
            ...
            if num_gts == 0:
                ...
                assigned_gt_inds[:] = 0
            return AssignResult(num_gts, assigned_gt_inds, bboxes.new_zeros(num_bboxes), labels=assigned_labels)
