...
network_configs = {
    "VoxelExpRes18BackBone8x": {"exfactor": 2, "basic_block_list": ["SparseBasicBlock"] * 4, "block_num": [2, 2, 2, 2]},
    "VoxelRes34BackBone8x": {"exfactor": 1, "basic_block_list": ["SparseBasicBlock"] * 4, "block_num": [3, 4, 6, 3]},
    "VoxelExpRes34BackBone8x": {"exfactor": 2, "basic_block_list": ["SparseBasicBlock"] * 4, "block_num": [3, 4, 6, 3]},
...
class SparseBottleNeckBlock(spconv.SparseModule):
    def __init__(self, inplanes, planes, stride=1, expansion=2, norm_fn=None, downsample=None, indice_key=None):
        ...
        self.conv1 = spconv.SubMConv3d(
            inplanes, midplane, kernel_size=1, stride=1, padding=1, bias=bias, in_situ=False, indice_key=indice_key
        )
        self.bn1 = norm_fn(midplane)
        self.relu = nn.ReLU()
        self.conv2 = spconv.SubMConv3d(
            midplane, midplane, kernel_size=3, stride=stride, padding=1, bias=bias, indice_key=indice_key
        )
        ...
        self.conv4 = spconv.SubMConv3d(
            midplane, planes, kernel_size=1, stride=1, padding=1, bias=bias, in_situ=False, indice_key=indice_key
        )
...
class VoxelResBasicBackBone8x(nn.Module):
    def __init__(self, model_name, input_channels, grid_size, last_pad=0, **kwargs):
        ...
        self.conv_input = spconv.SparseSequential(
            spconv.SubMConv3d(input_channels, 16 * self.exfactor, 3, padding=1, bias=False, indice_key="subm1"),
        ...
        self.conv1 = spconv.SparseSequential(
            *[
                basic_block_all[basic_block_list[0]](
                    16 * self.exfactor, 16 * self.exfactor, norm_fn=norm_fn, indice_key="res1"
                )
        ...
        self.conv2 = spconv.SparseSequential(
            ...
            *[
                basic_block_all[basic_block_list[1]](
                    32 * self.exfactor, 32 * self.exfactor, norm_fn=norm_fn, indice_key="res2"
                )
        ...
        self.conv3 = spconv.SparseSequential(
            ...
            *[
                basic_block_all[basic_block_list[2]](
                    64 * self.exfactor, 64 * self.exfactor, norm_fn=norm_fn, indice_key="res3"
                )
        ...
        self.conv4 = spconv.SparseSequential(
            ...
            *[
                basic_block_all[basic_block_list[3]](
                    128 * self.exfactor, 128 * self.exfactor, norm_fn=norm_fn, indice_key="res4"
                )
