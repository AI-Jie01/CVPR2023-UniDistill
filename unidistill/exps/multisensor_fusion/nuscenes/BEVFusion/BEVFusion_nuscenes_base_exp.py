...
from unidistill.utils.det3d_utils.initialize_utils import model_named_layers
from unidistill.engine.executors import Det3DEvaluator, Det3DInfer
from unidistill.layers.lr_scheduler import OnecycleLRScheduler
from unidistill.layers.optimizer.det3d import OptimWrapper
from unidistill.models.multisensor_fusion import BaseMultiSensorFusion, BaseEncoder
...
try:
    from unidistill.layers.head.det3d import TransFusionHead, HungarianAssigner3D
...
class Exp(BaseExp):
    ...
    def _configure_train_dataloader(self):
        from unidistill.data.sampler import InfiniteSampler
        ...
        train_loader = torch.utils.data.DataLoader(
            ...
            sampler=InfiniteSampler(
                len(train_dataset), seed=self.seed if self.seed else 0
            )
